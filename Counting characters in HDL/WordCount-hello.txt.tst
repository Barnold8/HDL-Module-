load WordCount.hdl,
output-file WordCount-hello.txt.out,
compare-to WordCount-hello.txt.cmp,
output-list reset%B1.1.1 count%B1.1.1 char%D1.3.1 charCount%D1.5.1 lineCount%D1.5.1 wordCount%D1.5.1;
